...
SOURCES=main.c src/stm8s_tim2.c src/stm8s_uart1_mini.c lib.c
#src/stm8s_flash.c
...
macinstall: all
	scp out.bin root@192.168.252.84:

install: all
	sudo /home/cleverfox/bin/stm8flash -c stlinkv2 -p stm8s103 -w out.bin
